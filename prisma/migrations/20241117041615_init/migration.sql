...
-- CreateIndex
CREATE UNIQUE INDEX "StripCustomer_userId_key" ON "StripCustomer"("userId");

-- CreateIndex
CREATE UNIQUE INDEX "StripCustomer_stripeCustomerId_key" ON "StripCustomer"("stripeCustomerId");
